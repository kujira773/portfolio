...
## i.  初期のポートフォリオの課題
webサイトの目的やターゲットを具体的に意識せずに作成してしまい、特定のターゲットに訴求のあるデザインに改善する必要があると考えた

## ii.　アジャイル方式の開発
こまめな改善のサイクルを回すために、アジャイル方式を一部取り入れた　　

###  KPI
良いところ(keep)・問題点(problem)・改善点(try)を洗い出し、具体的にどのように解決するかを考える　　

[作成したKPIはこちら]()　　

###  ユーザーストーリーとペルソナ　　
webサイトの目的が明確になるようにユーザーストーリーを考えた。ペルソナはヒアリングや調査・分析を元に設定されたものと仮定する。

###  カンバン
優先順位の高いものから取り掛かるようにチケットで管理する　　　

[作成したカンバンはこちら]()　　

## iii.　今後の課題　　
* カンバンを追加し忘れてるなど、うまく管理しきないところがあった
